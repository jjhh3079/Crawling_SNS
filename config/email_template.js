exports.email_verify = (email,token) =>{
  return {
    ...
    text : "링크를 클릭하여 인증해주세요 : " + "http://127.0.0.1:65005/email_verify?token=" + token
  };
};
exports.find_pw = (email,token) =>{
  return {
    ...
    to : email,
    subject: "Crawling SNS 이메일을 인증해주세요",
    text : "비밀번호를 다시 설정하려면 링크를 클릭하세요 : " + "http://127.0.0.1:65005/new_pw?token=" + token
  };
};
exports.eleven=(email)=>{
  return {
    ...
    text : "빨리 이벤트를 확인해보세요! http://127.0.0.1:65005"
  }
};
exports.tmon=(email)=>{
  return {
...
exports.ppomppu=(email)=>{
  return {
    ...
    text : "빨리 핫딜을 확인해보세요! http://127.0.0.1:65005"
  }
};
